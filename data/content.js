...
PH.CONTENT = {
  "1": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "head": [
          ...
          {
            "vi": "Trật tự và lực liên kết",
            "en": "Order and bonding"
          },
          {
            "vi": "Chuyển động phân tử",
            "en": "Molecular motion"
          },
          {
            "vi": "Hình dạng, thể tích",
            "en": "Shape and volume"
          }
        ],
        "rows": [
          [
            ...
            {
              "vi": "Trật tự xa, lực liên kết rất mạnh",
              "en": "Long-range order, very strong forces"
            },
            {
              "vi": "Chỉ dao động quanh vị trí cân bằng cố định",
              "en": "Only vibrate about fixed equilibrium positions"
            },
            {
              "vi": "Hình dạng và thể tích xác định",
              "en": "Definite shape and volume"
            }
          ],
          [
            {
            ...
            {
              "vi": "Trật tự gần, lực liên kết yếu hơn",
              "en": "Short-range order, weaker forces"
            },
            {
              "vi": "Dao động quanh vị trí cân bằng tạm thời, có thể dịch chuyển",
              "en": "Vibrate about temporary positions that can shift"
            },
            {
              "vi": "Thể tích xác định, hình dạng theo bình chứa",
              "en": "Definite volume, takes the shape of the container"
            }
          ],
          [
            {
            ...
            {
              "vi": "Hoàn toàn hỗn loạn, khoảng cách rất lớn, lực tương tác không đáng kể",
              "en": "Completely disordered, very large spacing, negligible forces"
            },
            {
              "vi": "Chuyển động tự do, chỉ tương tác khi va chạm",
              "en": "Move freely, interact only in collisions"
            },
            {
              "vi": "Chiếm toàn bộ thể tích bình chứa",
              "en": "Fills the whole container"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Ở thể nào các phân tử chỉ dao động quanh những vị trí cân bằng cố định?",
          "en": "In which state do the molecules only vibrate about fixed equilibrium positions?"
        },
        "options": [
          {
            "vi": "Thể khí",
        ...
        "correct": 2,
        "why": {
          "vi": "Ở thể rắn lực liên kết rất mạnh, giữ mỗi phân tử tại một vị trí cân bằng cố định.",
          "en": "In a solid the bonding forces are very strong and hold each molecule at a fixed equilibrium position."
        }
      },
      {
        "q": {
          "vi": "Quá trình chuyển từ thể lỏng sang thể khí được gọi là",
          "en": "The change from liquid to gas is called"
        },
        "options": [
          {
            "vi": "hoá hơi",
        ...
        "correct": 0,
        "why": {
          "vi": "Hoá hơi gồm bay hơi (ở mặt thoáng) và sôi (trong toàn bộ khối chất lỏng).",
          "en": "Vaporisation includes evaporation (at the surface) and boiling (throughout the liquid)."
        }
      },
      {
        "q": {
          "vi": "Khi nhiệt độ của vật tăng, chuyển động nhiệt của các phân tử",
          "en": "When the temperature of a body rises, the thermal motion of its molecules"
        },
        "options": [
          {
            "vi": "nhanh hơn",
          ...
          {
            "vi": "dừng lại khi tới 100 °C",
            "en": "stops at 100 °C"
          }
        ],
        "correct": 0,
        "why": {
          "vi": "Nhiệt độ càng cao thì tốc độ chuyển động hỗn loạn của phân tử càng lớn.",
          "en": "The higher the temperature, the faster the random motion of the molecules."
        }
      }
    ]
  },
  "2": {
    ...
    "blocks": [
      ...
      },
      {
        "type": "formula",
        "title": {
          "vi": "Định luật I của nhiệt động lực học",
        ...
        "vars": [
          {
            "sym": "ΔU",
            "vi": "độ biến thiên nội năng của hệ",
            "en": "change in internal energy of the system",
            "unit": "J"
          },
          {
            "sym": "A",
            "vi": "công mà hệ nhận được",
            "en": "work done on the system",
            "unit": "J"
          },
          {
            "sym": "Q",
            "vi": "nhiệt lượng mà hệ nhận được",
            "en": "heat supplied to the system",
            "unit": "J"
          }
        ],
        "note": {
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            {
              "vi": "hệ nhận công (bị nén)",
              "en": "work is done on the system (compressed)"
            },
            {
              "vi": "hệ thực hiện công (dãn nở)",
              "en": "the system does work (expands)"
            }
          ],
          [
            {
            ...
            {
              "vi": "hệ nhận nhiệt",
              "en": "the system absorbs heat"
            },
            {
              "vi": "hệ toả nhiệt",
              "en": "the system releases heat"
            }
          ],
          [
            {
            ...
            {
              "vi": "nội năng tăng",
              "en": "internal energy increases"
            },
            {
              "vi": "nội năng giảm",
              "en": "internal energy decreases"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Một lượng khí nhận nhiệt lượng 200 J và bị nén với công 50 J. Độ biến thiên nội năng của khí là",
          "en": "A gas absorbs 200 J of heat and is compressed by 50 J of work. The change in its internal energy is"
        },
        "options": [
          {
            "vi": "150 J",
        ...
        "correct": 3,
        "why": {
          "vi": "Hệ nhận cả nhiệt lẫn công: Q = +200 J, A = +50 J, nên ΔU = 250 J.",
          "en": "The system gains both heat and work: Q = +200 J, A = +50 J, so ΔU = 250 J."
        }
      },
      {
        "q": {
          "vi": "Cách nào sau đây làm thay đổi nội năng của vật bằng thực hiện công?",
          "en": "Which of these changes the internal energy of a body by doing work?"
        },
        "options": [
          {
            "vi": "Đun nóng nước trên bếp",
            "en": "Heating water on a stove"
          },
          {
            "vi": "Phơi vật ngoài nắng",
            "en": "Leaving an object in the sun"
          },
          {
            "vi": "Thả miếng đồng nóng vào nước lạnh",
            "en": "Dropping hot copper into cold water"
          },
          {
            "vi": "Cọ xát miếng kim loại lên mặt bàn",
            "en": "Rubbing a piece of metal on a table"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "Cọ xát là thực hiện công; ba trường hợp còn lại là truyền nhiệt.",
          "en": "Rubbing does work on the metal; the other three are heat transfer."
        }
      },
      {
        "q": {
          "vi": "Trong quá trình đẳng tích, biểu thức của định luật I trở thành",
          "en": "In an isochoric process the first law reduces to"
        },
        "options": [
          {
            "vi": "ΔU = Q",
        ...
        "correct": 0,
        "why": {
          "vi": "Thể tích không đổi nên khí không thực hiện công (A = 0).",
          "en": "The volume does not change, so no work is done (A = 0)."
        }
      }
    ]
  },
  "3": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Nhiệt độ 27 °C ứng với bao nhiêu kelvin?",
          "en": "What is 27 °C in kelvin?"
        },
        "options": [
          {
            "vi": "27 K",
      ...
      {
        "q": {
          "vi": "Nhiệt độ nào sau đây là thấp nhất?",
          "en": "Which of these temperatures is the lowest?"
        },
        "options": [
          {
            "vi": "0 K",
        ...
        "correct": 0,
        "why": {
          "vi": "0 K = −273 °C là độ không tuyệt đối, thấp hơn mọi nhiệt độ còn lại.",
          "en": "0 K = −273 °C is absolute zero, lower than all the others."
        }
      },
      {
        "q": {
          "vi": "Hai vật tiếp xúc nhau mà không có truyền nhiệt giữa chúng khi chúng có cùng",
          "en": "Two bodies in contact exchange no heat when they have the same"
        },
        "options": [
          {
            "vi": "khối lượng",
        ...
        "correct": 2,
        "why": {
          "vi": "Cân bằng nhiệt xảy ra khi hai vật có cùng nhiệt độ.",
          "en": "Thermal equilibrium means the two bodies are at the same temperature."
        }
      }
    ]
  },
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "Q",
            "vi": "nhiệt lượng vật nhận vào hoặc toả ra",
            "en": "heat absorbed or released",
            "unit": "J"
          },
          {
            "sym": "m",
            "vi": "khối lượng của vật",
            "en": "mass of the body",
            "unit": "kg"
          },
          {
    ...
    "selfcheck": [
      {
        ...
        "correct": 0,
        "why": {
          "vi": "Q = 2 · 4 200 · 50 = 420 000 J = 420 kJ.",
          "en": "Q = 2 × 4 200 × 50 = 420 000 J = 420 kJ."
        }
      },
      {
        "q": {
          "vi": "Đơn vị của nhiệt dung riêng là",
          "en": "The unit of specific heat capacity is"
        },
        "options": [
          {
            "vi": "J/(kg·K)",
      ...
      {
        "q": {
          "vi": "Hai vật cùng khối lượng, nhận cùng nhiệt lượng. Vật có nhiệt dung riêng lớn hơn sẽ",
          "en": "Two bodies of equal mass absorb the same heat. The one with the larger specific heat capacity"
        },
        "options": [
          {
            "vi": "tăng nhiệt độ nhiều hơn",
            "en": "warms up more"
          },
          {
            "vi": "tăng nhiệt độ như nhau",
            "en": "warms up by the same amount"
          },
          {
            "vi": "tăng nhiệt độ ít hơn",
            "en": "warms up less"
          },
          {
            "vi": "không tăng nhiệt độ",
            "en": "does not warm up at all"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "ΔT = Q/(mc): c càng lớn thì ΔT càng nhỏ.",
          "en": "ΔT = Q/(mc): the larger c is, the smaller the temperature rise."
        }
      }
    ]
  },
  "5": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "Q",
            "vi": "nhiệt lượng cần để nóng chảy hoàn toàn",
            "en": "heat needed to melt completely",
            "unit": "J"
          },
          {
            "sym": "λ",
            "vi": "nhiệt nóng chảy riêng của chất",
            "en": "specific latent heat of fusion",
            "unit": "J/kg"
          },
          {
            "sym": "m",
            "vi": "khối lượng chất rắn",
            "en": "mass of the solid",
            "unit": "kg"
          }
        ],
        "note": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Nhiệt lượng cần để làm tan hoàn toàn 0,5 kg nước đá ở 0 °C (λ = 3,34 × 10⁵ J/kg) là",
          "en": "The heat needed to melt 0.5 kg of ice at 0 °C completely (λ = 3.34 × 10⁵ J/kg) is"
        },
        "options": [
          {
            "vi": "6,68 × 10⁵ J",
        ...
        "correct": 2,
        "why": {
          "vi": "Q = λm = 3,34 × 10⁵ · 0,5 = 1,67 × 10⁵ J.",
          "en": "Q = λm = 3.34 × 10⁵ × 0.5 = 1.67 × 10⁵ J."
        }
      },
      {
        "q": {
          "vi": "Trong khi một chất rắn kết tinh đang nóng chảy, nhiệt độ của nó",
          "en": "While a crystalline solid is melting, its temperature"
        },
        "options": [
          {
            "vi": "tăng đều",
        ...
        "correct": 2,
        "why": {
          "vi": "Nhiệt lượng nhận vào dùng để phá vỡ mạng tinh thể chứ không làm tăng nhiệt độ.",
          "en": "The heat absorbed breaks the crystal lattice instead of raising the temperature."
        }
      },
      {
        "q": {
          "vi": "Nhiệt nóng chảy riêng của một chất phụ thuộc vào",
          "en": "The specific latent heat of fusion of a substance depends on"
        },
        "options": [
          {
            "vi": "khối lượng của vật",
            "en": "the mass of the body"
          },
          {
            "vi": "thời gian đun",
            "en": "the heating time"
          ...
          {
            "vi": "hình dạng của vật",
            "en": "the shape of the body"
          },
          {
            "vi": "bản chất của chất",
            "en": "the nature of the substance"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "λ là đặc trưng của từng chất, không phụ thuộc khối lượng hay hình dạng.",
          "en": "λ is a property of the substance itself, independent of mass or shape."
        }
      }
    ]
  },
  "6": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "Q",
            "vi": "nhiệt lượng cần để hoá hơi hoàn toàn",
            "en": "heat needed to vaporise completely",
            "unit": "J"
          },
          {
            "sym": "L",
            "vi": "nhiệt hoá hơi riêng của chất lỏng",
            "en": "specific latent heat of vaporisation",
            "unit": "J/kg"
          },
          {
            "sym": "m",
            "vi": "khối lượng chất lỏng",
            "en": "mass of the liquid",
            "unit": "kg"
          }
        ],
        "note": {
      ...
      },
      {
        ...
        "rows": [
          ...
          [
            ...
            {
              "vi": "nhiệt lượng làm nóng chảy 1 kg chất ở nhiệt độ nóng chảy",
              "en": "heat to melt 1 kg at the melting point"
            }
          ],
          [
            {
            ...
            {
              "vi": "nhiệt lượng làm hoá hơi hoàn toàn 1 kg chất lỏng ở nhiệt độ sôi",
              "en": "heat to vaporise 1 kg at the boiling point"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Nhiệt lượng cần để làm hoá hơi hoàn toàn 2 kg nước ở 100 °C (L = 2,26 × 10⁶ J/kg) là",
          "en": "The heat needed to vaporise 2 kg of water at 100 °C completely (L = 2.26 × 10⁶ J/kg) is"
        },
        "options": [
          {
            "vi": "1,13 × 10⁶ J",
        ...
        "correct": 1,
        "why": {
          "vi": "Q = Lm = 2,26 × 10⁶ · 2 = 4,52 × 10⁶ J.",
          "en": "Q = Lm = 2.26 × 10⁶ × 2 = 4.52 × 10⁶ J."
        }
      },
      {
        "q": {
          "vi": "Điểm khác nhau giữa sự sôi và sự bay hơi là",
          "en": "The difference between boiling and evaporation is that"
        },
        "options": [
          {
            "vi": "sôi xảy ra ở mọi nhiệt độ, bay hơi chỉ ở nhiệt độ sôi",
            "en": "boiling happens at any temperature, evaporation only at the boiling point"
          },
          {
            "vi": "bay hơi cần nhiệt, sôi thì không",
            "en": "evaporation needs heat, boiling does not"
          },
          {
            "vi": "cả hai đều chỉ xảy ra ở mặt thoáng",
            "en": "both happen only at the surface"
          },
          {
            "vi": "sôi xảy ra trong toàn khối chất lỏng ở nhiệt độ sôi, bay hơi xảy ra ở mặt thoáng tại mọi nhiệt độ",
            "en": "boiling happens throughout the liquid at the boiling point, evaporation at the surface at any temperature"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "Bay hơi xảy ra ở mặt thoáng tại mọi nhiệt độ; sôi xảy ra cả trong lòng chất lỏng ở nhiệt độ sôi.",
          "en": "Evaporation occurs at the surface at any temperature; boiling occurs inside the liquid too, at the boiling point."
        }
      },
      {
        "q": {
          "vi": "Trong quá trình sôi ở áp suất không đổi, nhiệt lượng cung cấp cho chất lỏng dùng để",
          "en": "During boiling at constant pressure, the heat supplied to the liquid is used to"
        },
        "options": [
          {
            "vi": "tăng động năng phân tử",
            "en": "increase the kinetic energy of the molecules"
          },
          {
            "vi": "tăng thế năng tương tác giữa các phân tử",
            "en": "increase the potential energy of interaction between molecules"
          },
          {
            "vi": "tăng nhiệt độ chất lỏng",
            "en": "raise the temperature of the liquid"
          },
          {
            "vi": "giảm nội năng của chất lỏng",
            "en": "reduce the internal energy of the liquid"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Nhiệt độ không đổi nên động năng không tăng; nhiệt lượng dùng để tách các phân tử ra xa nhau.",
          "en": "The temperature is constant so kinetic energy does not rise; the heat separates the molecules from one another."
        }
      }
    ]
  },
  "8": {
    ...
    "blocks": [
      ...
      },
      {
        "type": "formula",
        "title": {
          "vi": "Lượng chất và số phân tử",
          "en": "Amount of substance and number of molecules"
        },
        "math": "n = m/M = N/N_A",
        "vars": [
          {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Áp suất của chất khí tác dụng lên thành bình được gây ra bởi",
          "en": "The pressure a gas exerts on the container walls is caused by"
        },
        "options": [
          {
            "vi": "trọng lượng của các phân tử khí",
            "en": "the weight of the gas molecules"
          },
          {
            "vi": "lực hút giữa các phân tử khí",
            "en": "attraction between the gas molecules"
          },
          {
            "vi": "sự nở vì nhiệt của bình chứa",
            "en": "thermal expansion of the container"
          },
          {
            "vi": "va chạm của các phân tử khí với thành bình",
            "en": "collisions of the gas molecules with the walls"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "Mỗi va chạm truyền cho thành bình một xung lực; vô số va chạm tạo nên áp suất.",
          "en": "Each collision gives the wall an impulse; countless collisions add up to a steady pressure."
        }
      },
      {
        "q": {
          "vi": "Điều nào sau đây KHÔNG thuộc mô hình khí lí tưởng?",
          "en": "Which statement is NOT part of the ideal-gas model?"
        },
        "options": [
          {
            "vi": "Phân tử được coi là chất điểm",
            "en": "Molecules are treated as point particles"
          },
          {
            "vi": "Va chạm là hoàn toàn đàn hồi",
            "en": "Collisions are perfectly elastic"
          },
          {
            "vi": "Phân tử chỉ tương tác khi va chạm",
            "en": "Molecules interact only when they collide"
          },
          {
            "vi": "Các phân tử luôn hút nhau mạnh",
            "en": "Molecules always attract each other strongly"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "Trong mô hình khí lí tưởng, lực tương tác giữa các phân tử được bỏ qua trừ lúc va chạm.",
          "en": "In the ideal-gas model intermolecular forces are neglected except during collisions."
        }
      },
      {
        "q": {
          "vi": "Số phân tử có trong 2 mol khí oxygen là",
          "en": "The number of molecules in 2 mol of oxygen gas is"
        },
        "options": [
          {
            "vi": "6,02 × 10²³",
  ...
  "9": {
        ...
        "vars": [
          {
            "sym": "p",
            "vi": "áp suất của khí",
            "en": "pressure of the gas",
            "unit": "Pa"
          },
          {
            "sym": "V",
            "vi": "thể tích của khí",
            "en": "volume of the gas",
            "unit": "m³"
          }
        ],
        "note": {
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            {
              "vi": "1 N/m² (đơn vị SI của áp suất)",
              "en": "1 N/m² (SI unit of pressure)"
            }
          ],
          [
            {
            ...
            {
              "vi": "1,013 × 10⁵ Pa = 760 mmHg",
              "en": "1.013 × 10⁵ Pa = 760 mmHg"
            }
          ],
          [
            {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Nén đẳng nhiệt một lượng khí từ 8 lít xuống 2 lít. Áp suất ban đầu là 1,5 × 10⁵ Pa. Áp suất sau khi nén là",
          "en": "A gas is compressed isothermally from 8 L to 2 L. Its initial pressure is 1.5 × 10⁵ Pa. The final pressure is"
        },
        "options": [
          {
            "vi": "0,375 × 10⁵ Pa",
        ...
        "correct": 3,
        "why": {
          "vi": "p₂ = p₁V₁/V₂ = 1,5 × 10⁵ · 8/2 = 6 × 10⁵ Pa.",
          "en": "p₂ = p₁V₁/V₂ = 1.5 × 10⁵ × 8/2 = 6 × 10⁵ Pa."
        }
      },
      {
        "q": {
          "vi": "Trong hệ toạ độ (p, V), đường đẳng nhiệt có dạng",
          "en": "On a (p, V) diagram an isotherm is"
        },
        "options": [
          {
            "vi": "đường thẳng đi qua gốc toạ độ",
            "en": "a straight line through the origin"
          },
          {
            "vi": "đường thẳng song song với trục V",
            "en": "a straight line parallel to the V axis"
          },
          {
            "vi": "nhánh hypebol",
            "en": "a branch of a hyperbola"
          },
          {
            "vi": "parabol",
            "en": "a parabola"
        ...
        "correct": 2,
        "why": {
          "vi": "pV = const nên p = const/V: đồ thị là nhánh hypebol.",
          "en": "pV = const means p = const/V, whose graph is a branch of a hyperbola."
        }
      },
      {
        "q": {
          "vi": "Định luật Boyle áp dụng được khi",
          "en": "Boyle's law can be applied when"
        },
        "options": [
          {
            "vi": "khối lượng khí không đổi và nhiệt độ không đổi",
            "en": "the mass of gas is fixed and the temperature is constant"
          },
          {
            "vi": "áp suất được giữ không đổi",
            "en": "the pressure is kept constant"
          },
          {
            "vi": "thể tích được giữ không đổi",
            "en": "the volume is kept constant"
          },
          {
            "vi": "khối lượng khí thay đổi nhưng nhiệt độ không đổi",
            "en": "the mass of gas changes but the temperature is constant"
          }
        ],
        "correct": 0,
        "why": {
          "vi": "Định luật chỉ đúng cho một lượng khí xác định trong quá trình đẳng nhiệt.",
          "en": "The law holds only for a fixed mass of gas in an isothermal process."
        }
      }
    ]
  },
  "10": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Một lượng khí ở 27 °C có thể tích 3 lít. Nung nóng đẳng áp đến 127 °C thì thể tích khí là",
          "en": "A gas at 27 °C occupies 3 L. Heated at constant pressure to 127 °C, its volume becomes"
        },
        "options": [
          {
            "vi": "3 lít",
        ...
        "correct": 3,
        "why": {
          "vi": "V₂ = V₁T₂/T₁ = 3 · 400/300 = 4 lít.",
          "en": "V₂ = V₁T₂/T₁ = 3 × 400/300 = 4 L."
        }
      },
      {
        "q": {
          "vi": "Định luật Charles phát biểu: ở áp suất không đổi, thể tích của một lượng khí xác định",
          "en": "Charles's law states that at constant pressure the volume of a fixed mass of gas"
        },
        "options": [
          {
            "vi": "tỉ lệ thuận với nhiệt độ tuyệt đối",
            "en": "is directly proportional to absolute temperature"
          },
          {
            "vi": "tỉ lệ thuận với nhiệt độ Celsius",
            "en": "is directly proportional to Celsius temperature"
          },
          {
            "vi": "tỉ lệ nghịch với nhiệt độ tuyệt đối",
            "en": "is inversely proportional to absolute temperature"
          },
          {
            "vi": "không phụ thuộc nhiệt độ",
            "en": "does not depend on temperature"
          }
        ],
        "correct": 0,
        "why": {
          "vi": "V/T = const với T tính bằng kelvin.",
          "en": "V/T = const with T in kelvin."
        }
      },
      {
        "q": {
          "vi": "Trong hệ toạ độ (V, T), đường đẳng áp là",
          "en": "On a (V, T) diagram an isobar is"
        },
        "options": [
          {
            "vi": "nhánh hypebol",
          ...
          {
            "vi": "đường thẳng song song với trục T",
            "en": "a straight line parallel to the T axis"
          },
          {
            "vi": "đường thẳng có đường kéo dài đi qua gốc toạ độ",
            "en": "a straight line whose extension passes through the origin"
          },
          {
            "vi": "đường thẳng song song với trục V",
            "en": "a straight line parallel to the V axis"
  ...
  "11": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "title": {
          ...
          "en": "Equation of state of an ideal gas"
        },
      ...
      },
      {
        ...
        "rows": [
          ...
          [
            ...
            {
              "vi": "đường thẳng qua gốc trong (V, T)",
              "en": "straight line through origin on (V, T)"
            }
          ],
          [
            {
            ...
            {
              "vi": "đường thẳng qua gốc trong (p, T)",
              "en": "straight line through origin on (p, T)"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Một lượng khí ở trạng thái p₁ = 2 atm, V₁ = 10 lít, T₁ = 300 K chuyển sang trạng thái p₂ = 4 atm, T₂ = 600 K. Thể tích V₂ bằng",
          "en": "A gas goes from p₁ = 2 atm, V₁ = 10 L, T₁ = 300 K to p₂ = 4 atm, T₂ = 600 K. The volume V₂ is"
        },
        "options": [
          {
            "vi": "10 lít",
        ...
        "correct": 0,
        "why": {
          "vi": "V₂ = p₁V₁T₂/(p₂T₁) = 2 · 10 · 600/(4 · 300) = 10 lít.",
          "en": "V₂ = p₁V₁T₂/(p₂T₁) = 2 × 10 × 600/(4 × 300) = 10 L."
        }
      },
      {
        "q": {
          "vi": "Trong bình kín có thể tích không đổi, khi nhiệt độ tuyệt đối của khí tăng gấp đôi thì áp suất khí",
          "en": "In a rigid sealed container, when the absolute temperature of the gas doubles, its pressure"
        },
        "options": [
          {
            "vi": "giảm một nửa",
        ...
        "correct": 1,
        "why": {
          "vi": "Quá trình đẳng tích: p/T = const nên p tỉ lệ thuận với T.",
          "en": "Isochoric process: p/T = const, so p is proportional to T."
        }
      },
      {
        "q": {
          "vi": "Trong hệ SI, hằng số khí lí tưởng R có giá trị",
          "en": "In SI units the ideal-gas constant R equals"
        },
        "options": [
          {
            "vi": "6,02 × 10²³ mol⁻¹",
        ...
        "correct": 2,
        "why": {
          "vi": "1,38 × 10⁻²³ J/K là hằng số Boltzmann, 6,02 × 10²³ mol⁻¹ là số Avogadro.",
          "en": "1.38 × 10⁻²³ J/K is the Boltzmann constant and 6.02 × 10²³ mol⁻¹ the Avogadro constant."
        }
      }
    ]
  },
  "12": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "μ",
            "vi": "mật độ phân tử (số phân tử trong một đơn vị thể tích)",
            "en": "number density (molecules per unit volume)",
            "unit": "m⁻³"
          },
          {
            "sym": "m",
            "vi": "khối lượng một phân tử",
            "en": "mass of one molecule",
            "unit": "kg"
          },
          {
            "sym": "v̄²",
            "vi": "trung bình của bình phương tốc độ phân tử",
            "en": "mean square speed of the molecules",
            "unit": "m²/s²"
          },
          {
            "sym": "Ē_đ",
            "vi": "động năng tịnh tiến trung bình của một phân tử",
            "en": "mean translational kinetic energy of a molecule",
            "unit": "J"
          }
        ],
        "note": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Khi nhiệt độ tuyệt đối của khí tăng gấp đôi, động năng tịnh tiến trung bình của phân tử",
          "en": "When the absolute temperature of a gas doubles, the mean translational kinetic energy of a molecule"
        },
        "options": [
          {
            "vi": "tăng gấp đôi",
        ...
        "correct": 0,
        "why": {
          "vi": "Ē_đ = (3/2)kT tỉ lệ thuận với T.",
          "en": "Ē_đ = (3/2)kT is proportional to T."
        }
      },
      {
        "q": {
          "vi": "Động năng tịnh tiến trung bình của một phân tử khí ở 27 °C là (k = 1,38 × 10⁻²³ J/K)",
          "en": "The mean translational kinetic energy of a gas molecule at 27 °C is (k = 1.38 × 10⁻²³ J/K)"
        },
        "options": [
          {
            "vi": "6,21 × 10⁻²¹ J",
        ...
        "correct": 0,
        "why": {
          "vi": "T = 300 K: Ē_đ = 1,5 · 1,38 × 10⁻²³ · 300 = 6,21 × 10⁻²¹ J.",
          "en": "T = 300 K: Ē_đ = 1.5 × 1.38 × 10⁻²³ × 300 = 6.21 × 10⁻²¹ J."
        }
      },
      {
        "q": {
          "vi": "Theo mô hình động học phân tử, áp suất của chất khí tỉ lệ thuận với",
          "en": "According to the kinetic model, the pressure of a gas is proportional to"
        },
        "options": [
          {
            "vi": "trung bình của bình phương tốc độ phân tử",
            "en": "the mean square speed of the molecules"
          },
          {
            "vi": "tốc độ trung bình của phân tử",
            "en": "the mean speed of the molecules"
          },
          {
            "vi": "căn bậc hai của nhiệt độ",
            "en": "the square root of the temperature"
          },
          {
            "vi": "thể tích của bình",
            "en": "the volume of the container"
          }
        ],
        "correct": 0,
        "why": {
          "vi": "p = (1/3)μmv̄²: áp suất tỉ lệ với v̄², tức là với động năng trung bình.",
          "en": "p = (1/3)μmv̄²: pressure is proportional to v̄², i.e. to the mean kinetic energy."
        }
      }
    ]
  },
  "14": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "head": [
          ...
          {
            "vi": "Dạng đường sức",
            "en": "Shape of field lines"
          },
          {
            "vi": "Cách xác định chiều",
            "en": "How to find the direction"
          }
        ],
        "rows": [
          [
            ...
            {
              "vi": "Đường cong đi ra từ cực Bắc, đi vào cực Nam ở bên ngoài nam châm",
              "en": "Curves leaving the north pole and entering the south pole outside the magnet"
            },
            {
              "vi": "Chiều từ cực Bắc sang cực Nam bên ngoài nam châm",
              "en": "From north to south outside the magnet"
            }
          ],
          [
            {
              "vi": "Dòng điện thẳng dài",
              "en": "Long straight current"
            },
            {
              "vi": "Các đường tròn đồng tâm nằm trong mặt phẳng vuông góc với dây",
              "en": "Concentric circles in planes perpendicular to the wire"
            },
            {
              "vi": "Quy tắc nắm tay phải: ngón cái theo chiều dòng điện, các ngón khum lại chỉ chiều đường sức",
              "en": "Right-hand grip rule: thumb along the current, curled fingers give the field direction"
            }
          ],
          [
            {
              "vi": "Ống dây có dòng điện",
              "en": "Current-carrying solenoid"
            },
            {
              "vi": "Bên trong gần như song song, cách đều (từ trường đều); bên ngoài giống nam châm thẳng",
              "en": "Nearly parallel and evenly spaced inside (uniform field); like a bar magnet outside"
            },
            {
              "vi": "Quy tắc nắm tay phải: các ngón khum theo chiều dòng điện, ngón cái chỉ chiều đường sức trong lòng ống (cực Bắc)",
              "en": "Right-hand grip rule: fingers curl with the current, thumb gives the field inside the coil (north end)"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Tính chất cơ bản của từ trường là",
          "en": "The basic property of a magnetic field is that it"
        },
        "options": [
          {
            "vi": "tác dụng lực lên mọi vật đứng yên",
            "en": "exerts a force on every object at rest"
          },
          {
            "vi": "làm nóng mọi vật đặt trong nó",
            "en": "heats any object placed in it"
          },
          {
            "vi": "tác dụng lực từ lên nam châm hoặc dòng điện đặt trong nó",
            "en": "exerts a magnetic force on a magnet or current placed in it"
          },
          {
            "vi": "chỉ tồn tại xung quanh nam châm vĩnh cửu",
            "en": "exists only around permanent magnets"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "Từ trường được nhận biết qua lực từ tác dụng lên nam châm hay dòng điện.",
          "en": "A magnetic field is detected through the force it exerts on magnets or currents."
        }
      },
      {
        "q": {
          "vi": "Đường sức từ của dòng điện thẳng dài có dạng",
          "en": "The field lines of a long straight current are"
        },
        "options": [
          {
            "vi": "những đường thẳng song song với dây",
            "en": "straight lines parallel to the wire"
          },
          {
            "vi": "những đường xoắn ốc quanh dây",
            "en": "spirals around the wire"
          },
          {
            "vi": "những đường tròn đồng tâm nằm trong mặt phẳng vuông góc với dây",
            "en": "concentric circles in planes perpendicular to the wire"
          },
          {
            "vi": "những đường thẳng xuất phát từ dây, vuông góc với dây",
            "en": "straight lines radiating out from the wire"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "Từ phổ của dòng điện thẳng là các vòng tròn đồng tâm có tâm trên dây dẫn.",
          "en": "The field pattern of a straight current is a set of concentric circles centred on the wire."
        }
      },
      {
        "q": {
          "vi": "Ở vùng các đường sức từ được vẽ dày hơn thì",
          "en": "Where the field lines are drawn closer together,"
        },
        "options": [
          {
            "vi": "từ trường yếu hơn",
            "en": "the field is weaker"
          },
          {
            "vi": "không kết luận được",
            "en": "nothing can be concluded"
          },
          {
            "vi": "từ trường bằng không",
            "en": "the field is zero"
          },
          {
            "vi": "từ trường mạnh hơn",
            "en": "the field is stronger"
          }
        ],
        "correct": 3,
        "why": {
          "vi": "Mật độ đường sức biểu thị độ mạnh của từ trường.",
          "en": "The density of field lines represents the strength of the field."
        }
      }
    ]
  },
  "15": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          ...
          {
            "sym": "L",
            "vi": "chiều dài đoạn dây trong từ trường",
            "en": "length of conductor in the field",
            "unit": "m"
          },
          {
            "sym": "α",
            "vi": "góc giữa chiều dòng điện và vectơ B",
            "en": "angle between the current and B",
            "unit": "°"
          }
        ],
        "note": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Đoạn dây dài 20 cm mang dòng điện 5 A đặt vuông góc với từ trường đều B = 0,1 T. Lực từ tác dụng lên đoạn dây là",
          "en": "A 20 cm conductor carrying 5 A is placed perpendicular to a uniform field B = 0.1 T. The magnetic force on it is"
        },
        "options": [
          {
            "vi": "0,01 N",
        ...
        "correct": 1,
        "why": {
          "vi": "F = BIL = 0,1 · 5 · 0,2 = 0,1 N.",
          "en": "F = BIL = 0.1 × 5 × 0.2 = 0.1 N."
        }
      },
      {
        "q": {
          "vi": "Lực từ tác dụng lên đoạn dây dẫn mang dòng điện bằng không khi đoạn dây",
          "en": "The magnetic force on a current-carrying conductor is zero when the conductor is"
        },
        "options": [
          {
            "vi": "vuông góc với đường sức từ",
            "en": "perpendicular to the field lines"
          },
          {
            "vi": "song song với đường sức từ",
            "en": "parallel to the field lines"
          },
          {
            "vi": "hợp với đường sức từ góc 45°",
            "en": "at 45° to the field lines"
          },
          {
            "vi": "mang dòng điện rất lớn",
            "en": "carrying a very large current"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Khi α = 0° hoặc 180°, sinα = 0 nên F = 0.",
          "en": "When α = 0° or 180°, sinα = 0 so F = 0."
        }
      },
      {
        "q": {
          "vi": "Trong quy tắc bàn tay trái, ngón cái choãi ra chỉ chiều của",
          "en": "In the left-hand rule the outstretched thumb gives the direction of"
        },
        "options": [
          {
            "vi": "dòng điện",
        ...
        "correct": 3,
        "why": {
          "vi": "Lòng bàn tay hứng đường sức, ngón tay theo dòng điện, ngón cái chỉ lực từ.",
          "en": "Field lines into the palm, fingers along the current, thumb gives the force."
        }
      }
    ]
  },
  "16": {
    ...
    "blocks": [
      {
        ...
        "vars": [
          {
            "sym": "Φ",
            "vi": "từ thông qua mặt S",
            "en": "magnetic flux through the surface",
            "unit": "Wb"
          },
          {
            "sym": "B",
          ...
          {
            "sym": "S",
            "vi": "diện tích mặt phẳng",
            "en": "area of the surface",
            "unit": "m²"
          },
          {
            "sym": "α",
            "vi": "góc giữa vectơ pháp tuyến n của mặt S và vectơ B",
            "en": "angle between the normal n to the surface and B",
            "unit": "°"
          }
        ],
        "note": {
      ...
      },
      {
        ...
        "vars": [
          ...
          {
            "sym": "N",
            "vi": "số vòng dây của mạch",
            "en": "number of turns",
            "unit": "—"
          },
          {
            "sym": "ΔΦ",
            "vi": "độ biến thiên từ thông qua mỗi vòng",
            "en": "change of flux through one turn",
            "unit": "Wb"
          },
          {
            "sym": "Δt",
            "vi": "khoảng thời gian biến thiên",
            "en": "time interval",
            "unit": "s"
          }
        ],
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Khung dây phẳng có diện tích 0,02 m² đặt trong từ trường đều B = 0,5 T, vectơ pháp tuyến của khung hợp với B góc 60°. Từ thông qua khung là",
          "en": "A flat coil of area 0.02 m² is in a uniform field B = 0.5 T with its normal at 60° to B. The flux through it is"
        },
        "options": [
          {
            "vi": "8,7 × 10⁻³ Wb",
        ...
        "correct": 1,
        "why": {
          "vi": "Φ = BScosα = 0,5 · 0,02 · cos60° = 5 × 10⁻³ Wb.",
          "en": "Φ = BScosα = 0.5 × 0.02 × cos60° = 5 × 10⁻³ Wb."
        }
      },
      {
        "q": {
          "vi": "Từ thông qua mỗi vòng của một cuộn dây 100 vòng giảm đều từ 0,2 Wb về 0 trong 0,1 s. Độ lớn suất điện động cảm ứng trong cuộn dây là",
          "en": "The flux through each turn of a 100-turn coil falls uniformly from 0.2 Wb to zero in 0.1 s. The magnitude of the induced e.m.f. is"
        },
        "options": [
          {
            "vi": "200 V",
      ...
      {
        "q": {
          "vi": "Đưa cực Bắc của nam châm lại gần một vòng dây kín. Dòng điện cảm ứng trong vòng dây sinh ra từ trường",
          "en": "The north pole of a magnet is moved toward a closed loop. The induced current produces a field that"
        },
        "options": [
          {
            "vi": "ngược chiều với từ trường của nam châm, đẩy nam châm ra",
            "en": "opposes the magnet's field and repels the magnet"
          },
          {
            "vi": "cùng chiều với từ trường của nam châm",
            "en": "is in the same direction as the magnet's field"
          },
          {
            "vi": "bằng không",
            "en": "is zero"
          ...
          {
            "vi": "vuông góc với từ trường của nam châm",
            "en": "is perpendicular to the magnet's field"
          }
        ],
        "correct": 0,
        "why": {
          "vi": "Từ thông tăng nên theo định luật Lenz từ trường cảm ứng chống lại sự tăng đó, tức ngược chiều từ trường ngoài.",
          "en": "The flux is increasing, so by Lenz's law the induced field opposes the increase, i.e. it is opposite to the external field."
        }
      }
    ]
  },
  "17": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          ...
          {
            "sym": "S",
            "vi": "diện tích một vòng",
            "en": "area of one turn",
            "unit": "m²"
          },
          {
            "sym": "ω",
            "vi": "tốc độ góc của khung",
            "en": "angular speed of the coil",
            "unit": "rad/s"
          },
          {
            "sym": "φ₀",
            "vi": "pha ban đầu của từ thông",
            "en": "initial phase of the flux",
            "unit": "rad"
          }
        ],
        "note": {
      ...
      },
      {
        "type": "formula",
        "title": {
          "vi": "Giá trị hiệu dụng của dòng điện xoay chiều",
          "en": "Root-mean-square (effective) values"
        },
        "math": "I = I₀/√2   ;   U = U₀/√2   ;   E = E₀/√2",
        "vars": [
          {
            "sym": "I",
            "vi": "cường độ dòng điện hiệu dụng",
            "en": "r.m.s. current",
            "unit": "A"
          },
          {
            "sym": "I₀",
            "vi": "cường độ dòng điện cực đại",
            "en": "peak current",
            "unit": "A"
          },
          {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Khung dây 200 vòng, diện tích 0,01 m², quay đều với tốc độ góc 100π rad/s trong từ trường đều B = 0,1 T vuông góc với trục quay. Suất điện động cực đại trong khung là",
          "en": "A coil of 200 turns and area 0.01 m² rotates at 100π rad/s in a uniform field B = 0.1 T perpendicular to the axis. The peak e.m.f. is"
        },
        "options": [
          {
            "vi": "6,28 V",
        ...
        "correct": 3,
        "why": {
          "vi": "E₀ = NBSω = 200 · 0,1 · 0,01 · 100π ≈ 62,8 V.",
          "en": "E₀ = NBSω = 200 × 0.1 × 0.01 × 100π ≈ 62.8 V."
        }
      },
      {
        "q": {
        ...
        "correct": 3,
        "why": {
          "vi": "I = I₀/√2 = 2 A; f = ω/(2π) = 100π/(2π) = 50 Hz.",
          "en": "I = I₀/√2 = 2 A; f = ω/(2π) = 100π/(2π) = 50 Hz."
        }
      },
      {
        "q": {
          "vi": "Trong máy phát điện xoay chiều, bộ phận tạo ra từ trường được gọi là",
          "en": "In an AC generator the part that produces the magnetic field is called the"
        },
        "options": [
          {
            "vi": "phần ứng",
        ...
        "correct": 2,
        "why": {
          "vi": "Phần cảm là nam châm tạo từ trường; phần ứng là các cuộn dây sinh suất điện động.",
          "en": "The field system is the magnet that creates the field; the armature is the coils in which the e.m.f. is induced."
        }
      }
    ]
  },
  "18": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "U₁, U₂",
            "vi": "điện áp hiệu dụng ở cuộn sơ cấp, thứ cấp",
            "en": "r.m.s. voltages across primary and secondary",
            "unit": "V"
          },
          {
            "sym": "N₁, N₂",
            "vi": "số vòng của cuộn sơ cấp, thứ cấp",
            "en": "turns of primary and secondary",
            "unit": "—"
          },
          {
            "sym": "I₁, I₂",
            "vi": "cường độ hiệu dụng trong cuộn sơ cấp, thứ cấp",
            "en": "r.m.s. currents in primary and secondary",
            "unit": "A"
          }
        ],
        "note": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Máy biến áp có N₁ = 1 000 vòng, N₂ = 50 vòng, điện áp hiệu dụng ở cuộn sơ cấp là 220 V. Điện áp hiệu dụng ở cuộn thứ cấp để hở là",
          "en": "A transformer has N₁ = 1 000 turns, N₂ = 50 turns and 220 V r.m.s. across the primary. The open-circuit secondary voltage is"
        },
        "options": [
          {
            "vi": "4 400 V",
      ...
      {
        "q": {
          "vi": "Máy biến áp KHÔNG thể",
          "en": "A transformer CANNOT"
        },
        "options": [
          {
            "vi": "tăng điện áp xoay chiều",
            "en": "step up an alternating voltage"
          },
          {
            "vi": "hạ điện áp xoay chiều",
            "en": "step down an alternating voltage"
          },
          {
            "vi": "biến đổi điện áp một chiều không đổi",
            "en": "change a steady DC voltage"
          },
          {
            "vi": "làm thay đổi cường độ dòng điện",
            "en": "change the current"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "Điện áp một chiều không đổi không tạo ra từ thông biến thiên nên không có cảm ứng điện từ.",
          "en": "A steady DC voltage produces no changing flux, so nothing is induced."
        }
      },
      {
        "q": {
          "vi": "Lõi thép của máy biến áp được ghép từ các lá thép mỏng cách điện với nhau nhằm",
          "en": "The core of a transformer is laminated from thin insulated sheets in order to"
        },
        "options": [
          {
            "vi": "tăng khối lượng của máy",
            "en": "increase the mass of the transformer"
          },
          {
            "vi": "giảm dòng điện Foucault gây hao phí",
            "en": "reduce energy loss from eddy currents"
          },
          {
            "vi": "tăng điện áp ở cuộn thứ cấp",
            "en": "raise the secondary voltage"
          },
          {
            "vi": "tăng tần số dòng điện",
            "en": "raise the frequency"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Các lá thép cách điện chia nhỏ đường đi của dòng Foucault, làm giảm hao phí toả nhiệt.",
          "en": "Insulated laminations break up the eddy-current paths and cut the heat loss."
        }
      }
    ]
  },
  "19": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Sóng điện từ có tần số 100 MHz truyền trong chân không có bước sóng",
          "en": "An electromagnetic wave of frequency 100 MHz in vacuum has a wavelength of"
        },
        "options": [
          {
            "vi": "0,3 m",
        ...
        "correct": 1,
        "why": {
          "vi": "λ = c/f = 3 × 10⁸/10⁸ = 3 m.",
          "en": "λ = c/f = 3 × 10⁸/10⁸ = 3 m."
        }
      },
      {
        "q": {
          "vi": "Trong sóng điện từ, vectơ E và vectơ B",
          "en": "In an electromagnetic wave the vectors E and B"
        },
        "options": [
          {
            "vi": "cùng phương và cùng pha",
            "en": "are parallel and in phase"
          },
          {
            "vi": "vuông góc với nhau, vuông góc với phương truyền và dao động cùng pha",
            "en": "are perpendicular to each other and to the direction of travel, and oscillate in phase"
          },
          {
            "vi": "vuông góc với nhau và dao động vuông pha",
            "en": "are perpendicular and oscillate 90° out of phase"
          },
          {
            "vi": "song song với phương truyền sóng",
            "en": "are parallel to the direction of travel"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Sóng điện từ là sóng ngang, E ⊥ B ⊥ phương truyền, E và B cùng pha.",
          "en": "An electromagnetic wave is transverse: E ⊥ B ⊥ direction of travel, with E and B in phase."
        }
      },
      {
        "q": {
          "vi": "Điện trường xoáy xuất hiện ở nơi có",
          "en": "A circulating (induced) electric field appears where there is"
        },
        "options": [
          {
            "vi": "điện tích đứng yên",
            "en": "a charge at rest"
          },
          {
            "vi": "từ trường biến thiên theo thời gian",
            "en": "a magnetic field changing with time"
          },
          {
            "vi": "từ trường không đổi",
            "en": "a constant magnetic field"
          },
          {
            "vi": "dòng điện không đổi",
            "en": "a steady current"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Theo Maxwell, từ trường biến thiên sinh ra điện trường xoáy có đường sức khép kín.",
          "en": "By Maxwell's theory, a changing magnetic field produces an electric field with closed field lines."
        }
      }
    ]
  },
  "21": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          {
            "sym": "A",
            "vi": "số khối (số nucleon)",
            "en": "mass number (number of nucleons)",
            "unit": "—"
          },
          {
            "sym": "Z",
            "vi": "số proton (nguyên tử số)",
            "en": "proton number (atomic number)",
            "unit": "—"
          },
          {
            "sym": "N",
      ...
      },
      {
        ...
        "vars": [
          ...
          {
            "sym": "r₀",
            "vi": "hằng số, r₀ ≈ 1,2 × 10⁻¹⁵ m",
            "en": "constant, r₀ ≈ 1.2 × 10⁻¹⁵ m",
            "unit": "m"
          }
        ],
        "note": {
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Hạt nhân ⁵⁶Fe (Z = 26) có",
          "en": "The nucleus ⁵⁶Fe (Z = 26) has"
        },
        "options": [
          {
            "vi": "26 proton và 56 neutron",
            "en": "26 protons and 56 neutrons"
          },
          {
            "vi": "30 proton và 26 neutron",
            "en": "30 protons and 26 neutrons"
          },
          {
            "vi": "26 proton và 30 neutron",
            "en": "26 protons and 30 neutrons"
          },
          {
            "vi": "56 proton và 26 neutron",
            "en": "56 protons and 26 neutrons"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "N = A − Z = 56 − 26 = 30 neutron.",
          "en": "N = A − Z = 56 − 26 = 30 neutrons."
        }
      },
      {
        "q": {
          "vi": "Các đồng vị của cùng một nguyên tố có",
          "en": "Isotopes of the same element have"
        },
        "options": [
          {
            "vi": "cùng số neutron, khác số proton",
            "en": "the same neutron number, different proton numbers"
          },
          {
            "vi": "cùng số proton, khác số neutron",
            "en": "the same proton number, different neutron numbers"
          },
          {
            "vi": "cùng số khối",
            "en": "the same mass number"
          },
          {
            "vi": "cùng khối lượng hạt nhân",
            "en": "the same nuclear mass"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Đồng vị có cùng Z (cùng vị trí trong bảng tuần hoàn) nhưng khác N nên khác A.",
          "en": "Isotopes share Z (the same place in the periodic table) but differ in N and hence in A."
        }
      },
      {
        "q": {
          "vi": "Đơn vị khối lượng nguyên tử u được định nghĩa bằng",
          "en": "The atomic mass unit u is defined as"
        },
        "options": [
          {
            "vi": "khối lượng của một proton",
            "en": "the mass of one proton"
          },
          {
            "vi": "1/12 khối lượng nguyên tử carbon-12",
            "en": "1/12 of the mass of a carbon-12 atom"
          },
          {
            "vi": "khối lượng của một nguyên tử hydrogen",
            "en": "the mass of one hydrogen atom"
          },
          {
            "vi": "1/16 khối lượng nguyên tử oxygen-16",
            "en": "1/16 of the mass of an oxygen-16 atom"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "1 u = 1/12 khối lượng nguyên tử ¹²C ≈ 1,66 × 10⁻²⁷ kg.",
          "en": "1 u = 1/12 of the mass of a ¹²C atom ≈ 1.66 × 10⁻²⁷ kg."
        }
      }
    ]
  },
  "22": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "vars": [
          ...
          {
            "sym": "m_p, m_n",
            "vi": "khối lượng proton, neutron",
            "en": "proton and neutron masses",
            "unit": "u"
          },
          {
            "sym": "m_hn",
            "vi": "khối lượng hạt nhân",
            "en": "mass of the nucleus",
            "unit": "u"
          },
          {
            "sym": "E_lk",
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Hạt nhân ⁴He có độ hụt khối 0,0304 u. Năng lượng liên kết của nó là (1 u = 931,5 MeV/c²)",
          "en": "The ⁴He nucleus has a mass defect of 0.0304 u. Its binding energy is (1 u = 931.5 MeV/c²)"
        },
        "options": [
          {
            "vi": "7,08 MeV",
        ...
        "correct": 2,
        "why": {
          "vi": "E_lk = 0,0304 · 931,5 ≈ 28,3 MeV (7,08 MeV là năng lượng liên kết riêng).",
          "en": "E_lk = 0.0304 × 931.5 ≈ 28.3 MeV (7.08 MeV is the binding energy per nucleon)."
        }
      },
      {
        "q": {
          "vi": "Đại lượng đặc trưng cho mức độ bền vững của hạt nhân là",
          "en": "The quantity that measures how stable a nucleus is, is the"
        },
        "options": [
          {
            "vi": "độ hụt khối",
        ...
        "correct": 1,
        "why": {
          "vi": "Hạt nhân có năng lượng liên kết riêng càng lớn thì càng bền vững.",
          "en": "The larger the binding energy per nucleon, the more stable the nucleus."
        }
      },
      {
        "q": {
          "vi": "Trong phản ứng hạt nhân, đại lượng nào sau đây KHÔNG được bảo toàn?",
          "en": "Which of the following is NOT conserved in a nuclear reaction?"
        },
        "options": [
          {
            "vi": "Điện tích",
          ...
          {
            "vi": "Năng lượng toàn phần",
            "en": "Total energy"
          }
        ],
        "correct": 1,
        "why": {
          "vi": "Khối lượng nghỉ thay đổi, phần chênh lệch chuyển thành năng lượng theo E = mc².",
          "en": "Rest mass changes; the difference appears as energy according to E = mc²."
        }
      }
    ]
  },
  "23": {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            {
              "vi": "dòng hạt nhân ⁴He, điện tích +2e",
              "en": "stream of ⁴He nuclei, charge +2e"
            },
            {
              "vi": "tốc độ cỡ 2 × 10⁷ m/s; ion hoá mạnh, đâm xuyên yếu (tờ giấy chặn được); lệch trong điện trường và từ trường",
              "en": "speed about 2 × 10⁷ m/s; strongly ionising, weakly penetrating (stopped by paper); deflected by electric and magnetic fields"
            }
          ],
          [
            {
            ...
            {
              "vi": "dòng electron (β⁻) hoặc positron (β⁺)",
              "en": "stream of electrons (β⁻) or positrons (β⁺)"
            },
            {
              "vi": "tốc độ gần bằng c; đâm xuyên mạnh hơn α (xuyên qua lá nhôm vài mm); lệch trong điện trường và từ trường, ngược chiều nhau",
              "en": "speed close to c; more penetrating than α (passes through a few mm of aluminium); deflected by fields, in opposite directions"
            }
          ],
          [
            {
            ...
            {
              "vi": "sóng điện từ có bước sóng rất ngắn (dưới 10⁻¹¹ m)",
              "en": "electromagnetic wave of very short wavelength (below 10⁻¹¹ m)"
            },
            {
              "vi": "không mang điện nên không lệch trong điện trường, từ trường; đâm xuyên rất mạnh (cần chì dày để chặn); thường đi kèm phân rã α hoặc β",
              "en": "uncharged, so not deflected by fields; very penetrating (needs thick lead); usually accompanies α or β decay"
            }
          ]
        ]
      },
      {
        ...
        "vars": [
          {
            "sym": "N",
            "vi": "số hạt nhân chưa phân rã ở thời điểm t",
            "en": "number of undecayed nuclei at time t",
            "unit": "—"
          },
          {
            "sym": "N₀",
            "vi": "số hạt nhân ban đầu",
            "en": "initial number of nuclei",
            "unit": "—"
          },
          {
            "sym": "T",
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Một chất phóng xạ có chu kì bán rã 8 ngày. Sau 24 ngày, phần trăm số hạt nhân đã phân rã là",
          "en": "A radioactive substance has a half-life of 8 days. After 24 days the percentage of nuclei that have decayed is"
        },
        "options": [
          {
            "vi": "12,5%",
        ...
        "correct": 1,
        "why": {
          "vi": "24 ngày = 3T nên còn lại 1/8 = 12,5%, đã phân rã 87,5%.",
          "en": "24 days = 3T, so 1/8 = 12.5% remains and 87.5% has decayed."
        }
      },
      {
        "q": {
          "vi": "Tia phóng xạ không bị lệch trong điện trường và từ trường là",
          "en": "The radiation that is not deflected by electric or magnetic fields is"
        },
        "options": [
          {
            "vi": "tia α",
        ...
        "correct": 2,
        "why": {
          "vi": "Tia γ là sóng điện từ, không mang điện tích.",
          "en": "γ rays are electromagnetic waves and carry no charge."
        }
      },
      {
        "q": {
          "vi": "Hằng số phóng xạ λ liên hệ với chu kì bán rã T theo hệ thức",
          "en": "The decay constant λ is related to the half-life T by"
        },
        "options": [
          {
            "vi": "λ = ln2/T",
        ...
        "correct": 0,
        "why": {
          "vi": "Từ N₀/2 = N₀e^(−λT) suy ra λT = ln2.",
          "en": "From N₀/2 = N₀e^(−λT) it follows that λT = ln2."
        }
      }
    ]
  },
  "24": {
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            {
              "vi": "xạ trị ung thư (nguồn ⁶⁰Co, máy gia tốc); chẩn đoán bằng đồng vị đánh dấu (xạ hình, chụp PET); khử trùng dụng cụ y tế",
              "en": "cancer radiotherapy (⁶⁰Co sources, accelerators); diagnosis with tracer isotopes (scintigraphy, PET scans); sterilising medical equipment"
            }
          ],
          [
            {
            ...
            {
              "vi": "đo độ dày, mật độ vật liệu; dò khuyết tật mối hàn bằng tia γ; đo mức chất lỏng trong bồn kín",
              "en": "measuring thickness and density; detecting weld flaws with γ rays; gauging liquid levels in sealed tanks"
            }
          ],
          [
            {
            ...
            {
              "vi": "chiếu xạ tạo giống đột biến; diệt khuẩn, bảo quản nông sản; dùng đồng vị đánh dấu nghiên cứu sự hấp thụ phân bón",
              "en": "irradiation to breed new varieties; sterilising and preserving produce; tracer isotopes to study fertiliser uptake"
            }
          ],
          [
            {
              "vi": "Khảo cổ, địa chất",
              "en": "Archaeology, geology"
            },
            {
              "vi": "xác định tuổi mẫu vật bằng ¹⁴C (T ≈ 5 730 năm) và các đồng vị khác",
              "en": "dating samples with ¹⁴C (T ≈ 5 730 years) and other isotopes"
            }
          ]
        ]
      },
    ...
    "selfcheck": [
      {
        "q": {
          "vi": "Trong lò phản ứng hạt nhân, các thanh điều khiển có tác dụng",
          "en": "In a nuclear reactor the control rods"
        },
        "options": [
          {
            "vi": "làm chậm neutron",
            "en": "slow down the neutrons"
          },
          {
            "vi": "tải nhiệt ra ngoài lò",
            "en": "carry heat out of the core"
          },
          {
            "vi": "hấp thụ bớt neutron để khống chế phản ứng dây chuyền",
            "en": "absorb neutrons to regulate the chain reaction"
          },
          {
            "vi": "cung cấp thêm neutron cho lò",
            "en": "supply extra neutrons"
          }
        ],
        "correct": 2,
        "why": {
          "vi": "Thanh bo hoặc cadmium hấp thụ neutron; đẩy vào sâu thì phản ứng chậm lại, rút ra thì phản ứng mạnh lên.",
          "en": "Boron or cadmium rods absorb neutrons; pushing them in slows the reaction, pulling them out speeds it up."
        }
      },
      {
        "q": {
          "vi": "Phản ứng dây chuyền được duy trì ổn định trong lò phản ứng khi hệ số nhân neutron k",
          "en": "A chain reaction runs steadily in a reactor when the neutron multiplication factor k is"
        },
        "options": [
          {
            "vi": "nhỏ hơn 1",
        ...
        "correct": 3,
        "why": {
          "vi": "k = 1: số phân hạch mỗi giây không đổi; k < 1 phản ứng tắt dần, k > 1 bùng nổ.",
          "en": "k = 1 keeps the fission rate constant; k < 1 dies out, k > 1 runs away."
        }
      },
      {
        "q": {
          "vi": "Để xác định tuổi của một mẫu gỗ cổ, người ta dùng đồng vị phóng xạ",
          "en": "To date an ancient piece of wood, one uses the radioactive isotope"
        },
        "options": [
          {
            "vi": "¹⁴C",
        ...
        "correct": 0,
        "why": {
          "vi": "Sinh vật ngừng hấp thụ ¹⁴C khi chết; tỉ lệ ¹⁴C còn lại cho biết thời gian đã trôi qua.",
          "en": "An organism stops taking in ¹⁴C when it dies; the remaining ¹⁴C fraction gives the elapsed time."
        }
      }
    ]
  }
