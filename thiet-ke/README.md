...
Thư mục này là **nguồn chuẩn** về giao diện và nội dung khi viết code; quy tắc chung ở `QUY-TAC-DU-AN.md` tại thư mục gốc.

| Tệp / thư mục | Dùng để |
|---|---|
| `THIET-KE.md` | Đặc tả: màu, chữ, đầu trang, menu sổ, ô tìm kiếm, ba mức ngôn ngữ, từng trang |
| `KE-HOACH.md` | Việc đã làm (24/9) và việc còn lại; mỗi việc có sẵn phần mô tả để làm theo |
...
- `QUY-TAC-DU-AN.md`: quy tắc làm việc của nhóm.
